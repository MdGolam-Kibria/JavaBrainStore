...
import com.CrackCode.interviewQuestion.designPattern.abstractFactory.agamisoft.AndroidAgamiSoftDeveloper;
...
public class BusinessAutomation implements Employee<AgamiSoftDeveloper, CrackCodeDeveloper> {
     ...
     */
    @Override
    public AgamiSoftDeveloper create(String positionName) {
        if (positionName.equalsIgnoreCase("Android Developer")) {
            return new AndroidAgamiSoftDeveloper();
        }
