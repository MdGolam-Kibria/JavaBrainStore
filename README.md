...
<b>45) Create table from anoher table or from any select query with table data using oracle<br/></b>
<b><u>Answer :- </u></b> <br/><br>

```sql
create table XXX as
SELECT 
    IS_COR_RET, RENTITY_ID, RENTITY_BRANCH, SUBMISSION_CODE, REPORT_CODE, ENTITY_REFERENCE, FIU_REF_NUMBER, SUBMISSION_DATE, CURRENCY_CODE_LOCAL, REASON, ACTION, TRANSACTIONNUMBER, INTERNAL_REF_NUMBER, BBL_SOL_ID, SOL_ID, TRANSACTION_LOCATION, TRANSACTION_DESCRIPTION, DATE_TRANSACTION, TELLER, AUTHORIZED, LATE_DEPOSIT, DATE_POSTING, VALUE_DATE, TRANSMODE_CODE, TRANSMODE_COMMENT, TRAN_CRNCY_CODE, AMOUNT_LOCAL, FROM_FUNDS_CODE, FROM_FUNDS_COMMENT, FOREIGN_CURRENCY_CODE, FOREIGN_AMOUNT, FOREIGN_EXCHANGE_RATE, PART_TRAN_TYPE, INSTITUTION_NAME, INSTITUTION_CODE, SWIFT, NON_BANK_INSTITUTION, ACCOUNT, ACID, BRANCH, CURRENCY_CODE, ACCOUNT_NAME, OPENED, CLOSED, BALANCE, STATUS_CODE, IBAN, CLIENT_NUMBER, PERSONAL_ACCOUNT_TYPE, NAME, COMMERCIAL_NAME, INCORPORATION_LEGAL_FORM_DESC, INCORPORATION_LEGAL_FORM, INCORPORATION_NUMBER, TPH_CONTACT_TYPE, TPH_COMMUNICATION_TYPE, TPH_COUNTRY_PREFIX, GENDER, TITLE, FIRST_NAME, MIDDLE_NAME, LAST_NAME, CUST_NAME, CUST_TYPE_CODE, BIRTHDATE, NATIONALITY1, RESIDENCE, RESIDENCE_TYPE, TPH_NUMBER, TPH_NUMBER1, ADDRESS_TYPE, ADDRESS, CITY, STATE_CODE, STATE, COUNTRY_CODE, MOTHERS_NAME, ALIAS, SPOUSE_NAME, SSN, DRIVING_LICENSE, CUST_EMP_ID, NAT_ID_CARD_NUM, PSPRT_NUM, BIRTH_REG_NO, TIN, BIN, PSPRT_ISSU_DATE, PSPRT_DET, PSPRT_EXP_DATE, PSPRT_ISSU_COUNTRY, MOBILE_NO, LAND_NO, EMAIL, OCCUPATION, BUSINESS, EMPLOYER_NAME, EMP_ADDRESS_TYPE, EMP_ADDRESS, EMP_ADDRESS2, EMP_CITY, EMP_STATE, EMP_COUNTRY_CODE, EMP_TPH_NUMBER, EMP_EMAIL, MARKETING_UNIT_GROUP_ID, INDICATORS, 
    REPORT_SUBMIT_DATE, 0 XML_TYPE
 FROM STG_GOAML_TRANSACTION_DATA where XML_TYPE='VALID';
COMMIT;
```

<b>46) Insert data to another table from a select query using oracle <br/></b>
<b><u>Answer :- </u></b> <br/><br>

```sql
INSERT INTO XXX (IS_COR_RET, RENTITY_ID, RENTITY_BRANCH, SUBMISSION_CODE, REPORT_CODE, ENTITY_REFERENCE, FIU_REF_NUMBER, SUBMISSION_DATE, CURRENCY_CODE_LOCAL, REASON, ACTION, TRANSACTIONNUMBER, INTERNAL_REF_NUMBER, BBL_SOL_ID, SOL_ID, TRANSACTION_LOCATION, TRANSACTION_DESCRIPTION, DATE_TRANSACTION, TELLER, AUTHORIZED, LATE_DEPOSIT, DATE_POSTING, VALUE_DATE, TRANSMODE_CODE, TRANSMODE_COMMENT, TRAN_CRNCY_CODE, AMOUNT_LOCAL, FROM_FUNDS_CODE, FROM_FUNDS_COMMENT, FOREIGN_CURRENCY_CODE, FOREIGN_AMOUNT, FOREIGN_EXCHANGE_RATE, PART_TRAN_TYPE, INSTITUTION_NAME, INSTITUTION_CODE, SWIFT, NON_BANK_INSTITUTION, ACCOUNT, ACID, BRANCH, CURRENCY_CODE, ACCOUNT_NAME, OPENED, CLOSED, BALANCE, STATUS_CODE, IBAN, CLIENT_NUMBER, PERSONAL_ACCOUNT_TYPE, NAME, COMMERCIAL_NAME, INCORPORATION_LEGAL_FORM_DESC, INCORPORATION_LEGAL_FORM, INCORPORATION_NUMBER, TPH_CONTACT_TYPE, TPH_COMMUNICATION_TYPE, TPH_COUNTRY_PREFIX, GENDER, TITLE, FIRST_NAME, MIDDLE_NAME, LAST_NAME, CUST_NAME, CUST_TYPE_CODE, BIRTHDATE, NATIONALITY1, RESIDENCE, RESIDENCE_TYPE, TPH_NUMBER, TPH_NUMBER1, ADDRESS_TYPE, ADDRESS, CITY, STATE_CODE, STATE, COUNTRY_CODE, MOTHERS_NAME, ALIAS, SPOUSE_NAME, SSN, DRIVING_LICENSE, CUST_EMP_ID, NAT_ID_CARD_NUM, PSPRT_NUM, BIRTH_REG_NO, TIN, BIN, PSPRT_ISSU_DATE, PSPRT_DET, PSPRT_EXP_DATE, PSPRT_ISSU_COUNTRY, MOBILE_NO, LAND_NO, EMAIL, OCCUPATION, BUSINESS, EMPLOYER_NAME, EMP_ADDRESS_TYPE, EMP_ADDRESS, EMP_ADDRESS2, EMP_CITY, EMP_STATE, EMP_COUNTRY_CODE, EMP_TPH_NUMBER, EMP_EMAIL, MARKETING_UNIT_GROUP_ID, INDICATORS, REPORT_SUBMIT_DATE, XML_TYPE)

SELECT 
    IS_COR_RET, RENTITY_ID, RENTITY_BRANCH, SUBMISSION_CODE, REPORT_CODE, ENTITY_REFERENCE, FIU_REF_NUMBER, SUBMISSION_DATE, CURRENCY_CODE_LOCAL, REASON, ACTION, TRANSACTIONNUMBER, INTERNAL_REF_NUMBER, BBL_SOL_ID, SOL_ID, TRANSACTION_LOCATION, TRANSACTION_DESCRIPTION, DATE_TRANSACTION, TELLER, AUTHORIZED, LATE_DEPOSIT, DATE_POSTING, VALUE_DATE, TRANSMODE_CODE, TRANSMODE_COMMENT, TRAN_CRNCY_CODE, AMOUNT_LOCAL, FROM_FUNDS_CODE, FROM_FUNDS_COMMENT, FOREIGN_CURRENCY_CODE, FOREIGN_AMOUNT, FOREIGN_EXCHANGE_RATE, PART_TRAN_TYPE, INSTITUTION_NAME, INSTITUTION_CODE, SWIFT, NON_BANK_INSTITUTION, ACCOUNT, ACID, BRANCH, CURRENCY_CODE, ACCOUNT_NAME, OPENED, CLOSED, BALANCE, STATUS_CODE, IBAN, CLIENT_NUMBER, PERSONAL_ACCOUNT_TYPE, NAME, COMMERCIAL_NAME, INCORPORATION_LEGAL_FORM_DESC, INCORPORATION_LEGAL_FORM, INCORPORATION_NUMBER, TPH_CONTACT_TYPE, TPH_COMMUNICATION_TYPE, TPH_COUNTRY_PREFIX, GENDER, TITLE, FIRST_NAME, MIDDLE_NAME, LAST_NAME, CUST_NAME, CUST_TYPE_CODE, BIRTHDATE, NATIONALITY1, RESIDENCE, RESIDENCE_TYPE, TPH_NUMBER, TPH_NUMBER1, ADDRESS_TYPE, ADDRESS, CITY, STATE_CODE, STATE, COUNTRY_CODE, MOTHERS_NAME, ALIAS, SPOUSE_NAME, SSN, DRIVING_LICENSE, CUST_EMP_ID, NAT_ID_CARD_NUM, PSPRT_NUM, BIRTH_REG_NO, TIN, BIN, PSPRT_ISSU_DATE, PSPRT_DET, PSPRT_EXP_DATE, PSPRT_ISSU_COUNTRY, MOBILE_NO, LAND_NO, EMAIL, OCCUPATION, BUSINESS, EMPLOYER_NAME, EMP_ADDRESS_TYPE, EMP_ADDRESS, EMP_ADDRESS2, EMP_CITY, EMP_STATE, EMP_COUNTRY_CODE, EMP_TPH_NUMBER, EMP_EMAIL, MARKETING_UNIT_GROUP_ID, INDICATORS, 
    REPORT_SUBMIT_DATE, 0 XML_TYPE
FROM STG_GOAML_TRANSACTION_DATA 
WHERE XML_TYPE='VALID';
COMMIT;
```
